...
namespace MAUtil
{
	...
	StringData<Tchar>::StringData(const Tchar* text, int len)
	...
	template <class Tchar>
	StringData<Tchar>::StringData(const Tchar* text)
	...
	template <class Tchar>
	StringData<Tchar>::StringData(int len)
		: Vector<Tchar>(len + 1), RefCounted(1)
	{
		this->resize(len);
		this->mData[len] = 0;
	...
	template <class Tchar>
	StringData<Tchar>::StringData(const StringData& other)
	...
	template <class Tchar>
	static StringData<Tchar>* getEmptyData();
	...
	template <class Tchar>
	BasicString<Tchar>::BasicString(int aCapacity)
	{
	...
	template <class Tchar>
	void BasicString<Tchar>::allocStringData(const Tchar* text, int len)
	{
		if (len < 0)
		{
	...
	template <class Tchar>
	BasicString<Tchar>::BasicString(const Tchar* text, int len)
	{
	...
	template <class Tchar>
	BasicString<Tchar>::BasicString(const Tchar* text)
	{
	...
	template <class Tchar>
	BasicString<Tchar>::BasicString(const BasicString& s)
	{
		sd = s.sd;
		sd->addRef();
	}
	...
	template <class Tchar>
	const Tchar* BasicString<Tchar>::c_str() const
	{
		return (const Tchar*) sd->mData;
	}

	template <class Tchar>
	BasicString<Tchar>& BasicString<Tchar>::operator=(const BasicString& s)
	{
	...
	template <class Tchar>
	bool BasicString<Tchar>::operator==(const BasicString& other) const
	{
	...
	template <class Tchar>
	void BasicString<Tchar>::append(const Tchar* other, int len)
	{
...
#if 1
	template <class Tchar>
	BasicString<Tchar> BasicString<Tchar>::operator+(Tchar c) const
	{
		BasicString s = *this;
		s += c;
		return s;
	...
	template <class Tchar>
	BasicString<Tchar>& BasicString<Tchar>::operator+=(Tchar c)
	{
		append(&c, 1);
		return *this;
	}
	...
	template <class Tchar>
	int BasicString<Tchar>::findLastOf(const Tchar findThis) const
	{
	...
	//TODO: cleanup
	template <class Tchar>
	void BasicString<Tchar>::insert(int position, Tchar c)
	{
		int otherLen = 1;
		int newLen = this->length() + otherLen;
		this->resize(newLen);
	...
	template <class Tchar>
	void BasicString<Tchar>::remove(int position, int number)
	{
		if (sd->getRefCount() > 1)
		{
	...
	template <class Tchar>
	int BasicString<Tchar>::size() const
	{
		return sd->size();
	}

	template <class Tchar>
	int BasicString<Tchar>::length() const
	{
		return sd->size();
	}

	template <class Tchar>
	int BasicString<Tchar>::capacity() const
	{
	...
	template <class Tchar>
	void BasicString<Tchar>::resize(int newLen)
	{
		reserve(newLen);
		sd->resize(newLen);
		(*sd)[newLen] = 0;
	...
	template <class Tchar>
	void BasicString<Tchar>::reserve(int newLen)
	{
		if (sd->getRefCount() > 1)
		{
	...
	template <class Tchar>
	void BasicString<Tchar>::setData(StringData<Tchar>* data)
	{
		sd->release();
		sd = data;
	}
	...
	template <class Tchar>
	Tchar* BasicString<Tchar>::pointer()
	{
		return sd->pointer();
	}
...
template <>
int tstrlen<char>(const char* str)
{
	return static_cast<int>(strlen(str));
}

template <>
int tstrcmp<char>(const char* a, const char* b)
{
	return strcmp(a, b);
}

template <class Tchar>
int tstrlen(const Tchar* str)
{
	return static_cast<int>(wcslen(str));
}

template <class Tchar>
int tstrcmp(const Tchar* a, const Tchar* b)
{
	return wcscmp(a, b);
}
